      ...
      <section className="hero">
        <div className="hero-text">
          ...
          <p className="subtitle">
            La plateforme d'accompagnement éducatif et administratif pour les étudiants étrangers
            en France. Trouvez une formation, une offre, suivez vos démarches et consultez les
            aides disponibles.
          </p>
